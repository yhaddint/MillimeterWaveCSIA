...
M_burst = [32, 32]; % Number of bursts in IA; For directional use [M_Tx_BF,M_Rx_BF] for beams in BS and UE
...
for ss = 1:SNR_num
    ...
    switch STOinfo
        ...
        case 0 % it's conservative to consider true correlation peak (detected peak is always higher than it!)
            mu_H1 = 0.6681 + mu(ss); % mean value of t^2-2t+1 when t \in [0,1]
